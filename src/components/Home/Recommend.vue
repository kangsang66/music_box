	...
	<div class="box">
		...
		<div class="box">
			<div class="recommend">
				...
				<van-swipe v-if="!Show" :loop="false" :width="103" :show-indicators="false">
					<van-swipe-item v-for="songInfo in RecommendInfo.songs" :key="songInfo.id">
						<!-- 路由传递参数使用{path:'',params:} -->
						<router-link :to="{ path: '/recommendMusic', query: { id: songInfo.id } }">
