<template>
	<div class="songlist">
		<div class="top">
			...
			<div class="top_right">
				...
				>
					...
					></path>
					<path
						d="M512 738.986667c-6.826667 0-13.653333-1.706667-18.773333-6.826667L343.04 580.266667c-10.24-10.24-10.24-25.6 0-35.84s25.6-10.24 35.84 0l133.12 133.12 133.12-133.12c10.24-10.24 25.6-10.24 35.84 0s10.24 25.6 0 35.84l-150.186667 150.186666c-5.12 5.12-11.946667 8.533333-18.773333 8.533334z"
						fill="#333333"
						p-id="25380"
					></path>
					<path
						d="M512 738.986667c-13.653333 0-25.6-11.946667-25.6-25.6V278.186667c0-13.653333 11.946667-25.6 25.6-25.6s25.6 11.946667 25.6 25.6v435.2c0 13.653333-11.946667 25.6-25.6 25.6z"
						fill="#333333"
						p-id="25381"
					></path>
				</svg>
		...
		<!-- 点击就传递该歌曲的信息 -->
		<div class="songbox" v-for="(ele, id) in itemlist" @click="playsong(ele, id)" :key="id">
			<div class="id">
				<span> {{ id + 1 }}</span>
			</div>
			<div class="songbox_center">
				...
				<!-- 歌手名 -->
				<!-- 专辑名 -->
				<span class="album"> {{ ele.ar[0].name }}<span class="sp">-</span>{{ ele.al.name }}</span>
			</div>
		...
		<div class="subscribers">
			<div class="left">
				<div v-for="(subscriber, id) in Subscribers.slice(0, 5)" :key="id">
					<img :src="subscriber.avatarUrl" alt="" />
				</div>
			</div>
			<div class="right" v-show="showSub">
				<span>{{ subscribedCount() + "人收藏" }}</span>
				<van-icon name="arrow" color="#989898" size="16" />
			</div>
		</div>
	</div>
</template>
